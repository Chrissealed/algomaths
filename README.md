...
Après avoir succinctement essayé plusieurs langages de programmation,
je me suis finalement tourné vers **Perl 6** qui émergeait au même moment et qui m'a paru pouvoir s'appliquer au codage des mathématiques
et qui constitue le cœur du projet du moins en l'état actuel des choses mais d'autres options sont possibles comme par exemple **Julia** qui est aussi un langage récent adapté au codage scientifique par destination.

Chaque langage éventuel devrait avoir sa branche dédiée. Par exemple j'ai créé initialement des branches pour les langages Ruby, C, Pascal, etc. Ces branches sont là pour information et doivent être considérées comme obsolètes.
