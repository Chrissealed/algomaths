...
celui-ci est implémenté par l'emploi de hash et renvoie soit un hash, soit un tableau,
selon la valeur de l'argument du champ 'Str $array-or-hash' qui peut prendre
l'une des valeurs suivantes : '@' ou 'array' pour renvoyer un tableau
ou bien '%' ou 'hash' pour renvoyer un hash.
